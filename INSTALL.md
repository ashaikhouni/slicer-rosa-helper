...
See [`cli/README.md`](cli/README.md) for usage and
[`docs/USER_GUIDE.md`](docs/USER_GUIDE.md) for the cross-surface mental
model (which surface to pick, how the stages compose).
