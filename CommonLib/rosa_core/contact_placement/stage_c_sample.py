...
of disk samples. When ``ctx.other_centerlines`` is set, voxels closer to
another shank's centerline than ours are zeroed before aggregating — the
cross-shank ownership mask. Eliminates passing-shank artifacts.
