...
# working unchanged.
#
# `refine_signature_via_axis_peaks` lives in
# candidate_seeds.axis_peak_refine and is re-exported below for
# back-compat with callers that import it from this module.
from .candidate_seeds.axis_peak_refine import (  # noqa: F401
